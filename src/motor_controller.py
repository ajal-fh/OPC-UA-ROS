...
# assign the variables from the opc_ua server	
	...
	direction_opcua_node.nodeId = 'ns=2;i=8'
	direction_opcua_node.qualifiedName = 'MyVariable'
	direction_opcua_data.type = 'bool'
	

	#node for speed give the nodeId and qualifiedName accordingly	
	#speed_pwm_opcua_node.nodeId = 'ns=2;i=9'
	#speed_pwm_opcua_node.qualifiedName = 'MyStringVariable'
	#speed_pwm_opcua_data.type = 'uint'
	
	#node for brake give the nodeId and qualifiedName accordingly
	#brake_opcua_node.nodeId = 'ns=2;i=8'
	#brake_opcua_node.qualifiedName = 'MyVariable'
	...
	while not rospy.is_shutdown():	
		...
		#speed_pwm_opcua_data.string_d = speed_pwm.data
